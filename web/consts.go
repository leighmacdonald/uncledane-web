...
var creds = []creditMeta{
	{
		...
		Music: []string{
			...
			"Super Monkey Ball 2 -- Under The Ocean (World 3)",
			"Super Monkey Ball 2 -- Monkey Dogfight",
			"The Legend Of Zelda: Link’s Awakening (Switch) -- Tal Tal Heights",
	...
	{
		URL:   "https://www.youtube.com/watch?v=UEMkQCswZf0",
		Title: "I Read Your TF2 Hot Takes…",
		Music: []string{
			"Team Fortress 2 -- Haunted Fortress",
			"Team Fortress 2 -- Misfortune Teller",
			"Animal Crossing New Leaf -- 1pm",
			"Animal Crossing New Leaf -- 2pm",
			"Animal Crossing New Leaf -- 5pm",
			"Animal Crossing New Leaf -- 10pm",
			"Animal Crossing New Horizons -- 5pm",
		},
	},
	{
		URL:   "https://www.youtube.com/watch?v=UNUd5gcAvRM",
		Title: "Opening 200 Summer Cases",
		Music: []string{
			"Mario Kart Double Dash -- First Place",
			"Mario Kart Wii -- First Place",
			"Mario Kart 8 -- First Place",
			"Lionel Quick -- Confidently Wandering",
			"Pokemon Anime -- Johto Victory Theme",
			"Kenny Loggins -- Danger Zone",
			"Rage Against The Machine -- Killing In The Name",
		},
	},
	{
		URL:   "https://www.youtube.com/watch?v=c6G9Jewb2RE",
		Title: "I Main Pyro Now",
		Music: []string{
			"Pokemon Scarlet/Violet -- Wild Battle Theme",
			"Pokemon Scarlet/Violet -- Wild Battle Theme (North Province)",
			"Pokemon Scarlet/Violet -- Wild Battle Theme (West Province)",
			"Pokemon Scarlet/Violet -- Wild Battle Theme (South Province)",
			"Pokemon Scarlet/Violet -- Tera Raid Battle Theme",
			"Pokemon Scarlet/Violet -- Champion Nemona Battle Theme",
			"Pokemon Scarlet/Violet -- Champion Battle Theme",
			"Pokemon HeartGold/SoulSilver -- Ecruteak City",
			"Pokemon HeartGold/SoulSilver -- Cianwood City",
			"Pokemon HeartGold/SoulSilver -- Cianwood City (Remix)",
			"Animal Crossing New Horizons -- 2pm",
	...
	{
		URL:   "https://www.youtube.com/watch?v=SfZHUWrJMbs",
		Title: "TF2 Makes Me Laugh",
		Music: []string{
			"Pokemon Sword/Shield -- Battle Tower Theme",
			"Pokemon Scarlet/Violet -- Sandwich Theme",
			"Super Smash Bros Melee -- Brinstar (Metroid)",
			"Super Smash Bros Melee -- Yoshi’s Story",
			"Animal Crossing New Horizons -- 7am",
			"John Williams -- Duel Of The Fates",
			"Tetris Theme",
			"Mission Impossible Theme",
			"Christmas Tunes On The Banjo",
		},
	},

	{
		URL:   "https://www.youtube.com/watch?v=c977-5lBJu4",
		Title: "The Ultimate Guide To Battle Engineer",
		Music: []string{
			"SilvaGunner -- Super Smash Bros Character Select (Extended Version)",
			"The Legend of Zelda: Ocarina of Time -- Great Fairy’s Fountain",
			"Animal Crossing New Horizons -- 10am (Sunny)",
